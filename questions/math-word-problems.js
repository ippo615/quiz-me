var mathWordQuestions = (function(){
	...
	var same1 = makeQuestionTransfer(
		function(n1,n2,nGiven){return nGiven;},
	...
	//'It is raining outside. {{NAME}} goes to the closest. What goes {{PRONOUN}} get?'
	//'{{NAME}} is hungry so {{PRONOUN}} goes to the store. What does {{NAME}} buy?'

	function weatherQuestion(){
		var stuff = {
			rain: 'coat umbrella'.split(' ')
		};
		return 'It is {{WEATHER}}. {{NAME}} goes to the closet. What does {{PRONOUN}} get before going outside?';
	}
